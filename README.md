...
| Skill                            | Description                                                                                                                                                                                                            |
| -------------------------------- | ---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| `avoid-ai-writing-patterns`      | Use when writing non-technical prose such as articles, wiki content, project descriptions, or blog posts where a natural, direct voice matters. Do not apply to technical documentation, API docs, or commit messages. |
